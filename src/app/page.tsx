...
export default function Home() {
  ...
  const BurningMatchstickIcon = () => (
    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[42px] h-[42px]" transform="rotate(-15 10 10)">
      ...
      <div className="flex items-center justify-center w-full max-w-4xl mx-auto mb-8">
        ...
        <AlertDialog>
          <AlertDialogTrigger asChild>
            <Button
              className="ml-4 p-2.5 rounded-full w-[62px] h-[62px]
