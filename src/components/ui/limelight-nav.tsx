...
export const LimelightNav = ({
  ...
  return (
    <nav className={`relative inline-flex items-center h-12 rounded-lg bg-card text-foreground border px-2 ${className}`}>
      {items.map(({ id, icon, label, onClick }, index) => (
          ...
          >
            <span
              className={`font-medium transition-opacity duration-100 ease-in-out whitespace-nowrap ${
